...
Discy does **not** bundle these. Download official releases yourself:
...
Users must install compatibility mods from their official authors:

- **Sophisticated Core / Storage / Backpacks** — copyright P3pp3rF1y, [All Rights Reserved](https://github.com/P3pp3rf1y/SophisticatedCore). Discy registers against public APIs (`IDiscHandler`, `SoundHandler`) and uses small compatibility mixins when Sophisticated Core is present.
- **Let's Do Furniture** — gramophone integration via optional mixin when Furniture is installed.
